...
class BaseModelMerger(ABC):
    ...
    def save_lora_adapter(self, state_dict: dict[str, torch.Tensor]):
        ...
        peft_dict = {
            "r": lora_rank,
            "lora_alpha": 32,  # lora_alpha is not set. An error should be raised to inform the user to set it manually.
        ...
        peft_config["base_model_name_or_path"] = "/root/paddlejob/workspace/llm/Qwen2.5-32B-Instruct"
